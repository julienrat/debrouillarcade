...
void setup()
{
  ...
  touchAttachInterrupt(T5, gotStart, threshold);
  touchAttachInterrupt(T0, gotDown, threshold);
  touchAttachInterrupt(T3, gotLeft, threshold);
  touchAttachInterrupt(T9, gotUp, threshold);
  touchAttachInterrupt(T7, gotB, threshold);
  touchAttachInterrupt(T2, gotRight, threshold);
  touchAttachInterrupt(T8, gotA, threshold);
